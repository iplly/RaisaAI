...
json vkmusicTool() {
  ...
  tool.function.description =
      ...
      "ВАЖНО: если пользователь говорит «включи мою музыку», «мои треки», "
      "«мои песни» — сразу вызывай VKMusicSkill с type=\"my\", "
      "track=\"\". Не задавай уточняющих вопросов.";
  tool.function.parameters.properties.insert(
      {"type",
       {"string", "search — конкретная песня, исполнитель или альбом; "
                  "playlist — плейлист, жанр или настроение; "
                  "mix — явная просьба включить микс, в том числе «мой микс»;"
                  "my — \"моя музыка\", \"мои треки\", \"мои песни\""
                  "НИКОГДА НЕ ИСПОЛЬЗУЙ ЛЮБЫЕ ДРУГИЕ ТИПЫ"}});
  tool.function.parameters.properties.insert(
      {"track",
       {"string",
        ...
        "**Для type=mix или type=my ВСЕГДА оставляй пустой строкой.** "
